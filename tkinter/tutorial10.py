...
canvas_widget.create_line(0, 0, 100, 20, fill='red')
#
# # Co-ordinates starts from top x, y to bottom right left
# canvas_widget.create_rectangle(3, 5, 400, 300, fill='grey')
#
#
